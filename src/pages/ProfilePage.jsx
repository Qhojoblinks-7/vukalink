...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen text-grey-100 bg-white   flex flex-col items-center justify-center py-10">
      <h1 className="text-4xl font-heading font-bold text-boldmb-8 dark:text-white">Your Profile</h1>
      <ProfileCard
        user={user}
        profile={profile}
