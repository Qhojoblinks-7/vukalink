    ...
    <div className="bg-gray-100   min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-grow p-4 md:p-8 md:ml-64 transition-all duration-300"> {/* md:ml-64 to make space for sidebar */}
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 w-full">
          ...
          <p className="ttext-grey-600 -900 mb-8 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link to="/company/manage-opportunities" className="block">
              <div className="bg-blue-600   text-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition-transform duration-200 hover:scale-105 hover:bg-blue-600  -dark">
            ...
            <Link to="/company/post-opportunity" className="block">
              <div className="bg-orange-500  text-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition-transform duration-200 hover:scale-105 hover:bg-orange-500 -dark">
            ...
            <Link to="/company/manage-opportunities" className="block"> {/* For simplicity, linking to manage ops */}
              <div className="bg-green-600  text-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center transform transition-transform duration-200 hover:scale-105 hover:bg-green-600 -dark">
            ...
            <Link to="/profile/edit" className="block">
              <div className="bg-white  ttext-grey-600 -900 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center border text-grey-600 -600  transform transition-transform duration-200 hover:scale-105 hover:shadow-lg">
                <BuildingOfficeIcon className="h-16 w-16 mb-4 font-bold " />
                <h2 className="text-xl font-semibold mb-2 font-heading">Edit Company Profile</h2>
                <p className="text-sm text-grey-600 -600 0">Update your company's public information.</p>
              </div>
            </Link>
            ...
            <Link to="/messages" className="block">
              <div className="bg-white  ttext-grey-600 -900 rounded-lg shadow-md p-6 flex flex-col items-center justify-center text-center border text-grey-600 -600  transform transition-transform duration-200 hover:scale-105 hover:shadow-lg">
                <BellIcon className="h-16 w-16 mb-4 font-bold " />
                <h2 className="text-xl font-semibold mb-2 font-heading">Messages</h2>
                <p className="text-sm text-grey-600 -600 0">Communicate with students and applicants.</p>
              </div>
            </Link>
