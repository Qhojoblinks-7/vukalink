...
const statuses = ['All', 'pending', 'reviewed', 'interview', 'offer', 'rejected']; // Use actual status values from Supabase
...
const DesktopApplicationsLayout = ({ applications }) => {
    ...
    const filteredApplications = applications.filter(app => {
        // Ensure app.currentStatus matches 'pending', 'reviewed', etc.
        const matchesStatus = activeStatusTab === 'All' || app.currentStatus.toLowerCase() === activeStatusTab.toLowerCase();
        const matchesSearch = searchTerm ?
            (app.jobTitle.toLowerCase().includes(searchTerm.toLowerCase()) ||
            app.company.toLowerCase().includes(searchTerm.toLowerCase())) : true;
        
        // Ensure dateAppliedFilter format (YYYY-MM-DD) matches app.dateApplied format
        const matchesDate = dateAppliedFilter ?
            app.dateApplied === dateAppliedFilter : true; 

        return matchesStatus && matchesSearch && matchesDate;
    });

    const sortedApplications = filteredApplications.sort((a, b) => {
        // Assume 'dateApplied' is already in a sortable format or parse it
