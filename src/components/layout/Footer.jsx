...
const Footer = () => {
  return (
    <footer className="bg-vuka-dark-blue text-vuka-white py-12 px-6 md:px-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-vuka-medium-blue pb-8 mb-8">
        {/* Logo and Mission */}
        <div className="col-span-1 md:col-span-1">
          <Link to="/">
            <img src={logo} alt="LinkUp Logo" className="h-10 w-auto mb-4" />
          </Link>
          <p className="text-vuka-light-grey text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2 text-vuka-light-grey text-sm">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-vuka-light-grey hover:text-blue-900  transition-colors">
              <Facebook size={24} />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-vuka-light-grey hover:text-blue-900  transition-colors">
              <Twitter size={24} />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-vuka-light-grey hover:text-blue-900  transition-colors">
              <Linkedin size={24} />
            </a>
          </div>
        </div>
      ...
      {/* Copyright */}
      <div className="text-center text-vuka-light-grey text-sm">
