...
const Footer = () => {
  return (
    <footer className="bg-blue-900   text-white py-12 px-6 md:px-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-blue-400 dark:border-gray-700 pb-8 mb-8">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-grey-600 -600  text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2 text-grey-600 -600  text-sm">
      ...
      {/* Copyright */}
      <div className="text-center text-grey-600 -600  text-sm">
