      ...
      <div className="flex-1 overflow-y-auto p-4 pb-20"> {/* pb-20 for bottom nav */}
        ...
        <div className="bg-white p-4 rounded-lg shadow-md mb-4">
          <div className="flex items-center mb-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-grey-600 -900">{opportunity.company}</h3>
              <p className="text-grey-600 -600 0 text-sm">{opportunity.title}</p>
            </div>
          </div>
          <div className="flex items-center text-grey-600 -700 text-sm mb-4 space-x-3">
        ...
        <div className="bg-white  p-4 rounded-lg shadow-md mb-4">
          <section className="mb-6">
            <h2 className="text-lg font-semibold text-grey-600 -900 mb-3">Description</h2>
            <p className="text-grey-600 -700 leading-relaxed whitespace-pre-wrap">{opportunity.aboutOpportunity}</p>
          </section>

          <section className="mb-6">
            <h2 className="text-lg font-semibold text-grey-600 -900 mb-3">Responsibilities</h2>
            <ul className="list-disc list-inside text-grey-600 -700 space-y-2">
          ...
          <section className="mb-6">
            <h2 className="text-lg font-semibold text-grey-600 -900 mb-3">Requirements</h2>
            <ul className="list-disc list-inside text-grey-600 -700 space-y-2">
          ...
          <section className="mb-6">
            <h2 className="text-lg font-semibold text-grey-600 -900 mb-3">Application Process</h2>
