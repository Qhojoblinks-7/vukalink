    ...
    <div className="flex flex-col h-full bg-vuka-grey-light">
      ...
      <div className="bg-vuka-dark-blue py-4 px-4 flex justify-between items-center shadow-md">
        {showConversationDetail ? (
          <button onClick={handleBackToList} className="text-vuka-white hover:text-vuka-blue">
        ...
        <span className="text-vuka-white text-lg font-semibold truncate max-w-[calc(100%-120px)]">
        ...
        <div className="flex items-center space-x-4">
          ...
          {showConversationDetail && (
            ...
            <>
              <Bars3Icon className="h-6 w-6 text-vuka-white cursor-pointer hover:text-vuka-blue" />
              <EllipsisVerticalIcon className="h-6 w-6 text-vuka-white cursor-pointer hover:text-vuka-blue" />
            </>
          )}
        </div>
      </div>
